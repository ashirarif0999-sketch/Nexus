...
export const Avatar: React.FC<AvatarProps> = ({
  ...
  return (
    <div className={clsx('avatar-wrapper', className)}>
      <div className="avatar-container relative inline-block">
        ...
        {status && (
          <span
            className={clsx('avatar-status absolute bottom-0 right-0 block rounded-full ring-2 ring-white', statusColors[status], statusSizes[size])}
          />
        )}
      </div>
    </div>
